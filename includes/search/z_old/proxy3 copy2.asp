...
intfind2=instr(request.ServerVariables("URL"),"/proxy3.asp") 'to be used later
...
if intfind > 0 then ' if exists
  ...
  thisfolder2=left(request.ServerVariables("URL"),intfind2)
...
searchstr = "http://10.30.15.145/search?q="&q&"&site=mlearning&client=mlearning&sitesearch="&thisfolder&"&proxyreload=1&sort=date%3AD%3AL%3Ad1&oe=UTF-8&ie=UTF-8&output=xml_no_dtd"
...
xsl.load(Server.MapPath( thisfolder2&"searchresults4.xsl")) 
