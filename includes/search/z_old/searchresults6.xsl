          ...
          <xsl:when test="$prev">
            <td nowrap="1">
              ...
              <span class="{$fontclass}">
                <a ctype="nav.prev"
                   href="/home/index.asp?param=googleresults&amp;start={$view_begin - $num_results - 1}">
        ...
        <xsl:choose>
          <xsl:when test="$next">
            <td nowrap="1">
              ...
              <span class="{$fontclass}">
              <a ctype="nav.next" href="/home/index.asp?param=googleresults&amp;start={$view_begin +
                $num_results - 1}">
                <xsl:if test="$navigation_style_to_use = 'google'">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <td>
        ...
        <a ctype="nav.page" href="/home/index.asp?param=googleresults&amp;start={$start}">
        <xsl:if test="$navigation_style = 'google'">
