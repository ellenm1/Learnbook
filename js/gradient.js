...
/*************************
// note: ellen has shut off the mac version of this until it can be fixed. It is miscalculating the height of the generated buttons when there are sub-sections
...
//window.attachEvent("printNavBar",createGradient);
...
function makeGrandParent(obj) {
	...
	disp == "block"?
	*/
	nSpan = document.createElement("div")/*:	nSpan = document.createElement("span")*/;
	mHTML = obj.innerHTML;
	obj.innerHTML = "";
	nSpan.innerHTML = mHTML;
	 nSpan.setAttribute("style","position:relative;z-index:10;"); 
	nSpan.setAttribute("id","gradientContainer");
