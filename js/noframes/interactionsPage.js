...
if ( (trackingmode == "scorm")&&APIOK() ){ 
	...
	if   (typeof ints!="undefined"){//if there is an interactions array...
		...
		var loadingMsgStr = '<div class="modal-header"><button type="button" class="close" data-dismiss="modal">×</button><h3>Loading...</h3></div>';
			loadingMsgStr +='<div class="modal-body"><p><img src="images/img/ajax-loader-3.gif"/>&nbsp;Loading data, please wait!<br></p></div>';
		...
		$('#dialog-modal').html(loadingMsgStr); 
...
function turnOnMsg(){   $('#dialog-modal').dialog(open); } 
function turnOffMsg(){ $('#dialog-modal').dialog('close');} 
